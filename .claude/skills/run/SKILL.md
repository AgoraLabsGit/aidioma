...
6. Implementation phases: complete real path, proof, seams/composition review. May invoke Cursor
   `code-review` as a helper; use `split-to-prs` only with Mike’s explicit OK.
