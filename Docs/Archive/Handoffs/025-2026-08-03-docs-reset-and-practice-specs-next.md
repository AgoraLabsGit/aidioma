...
**Cleanup status, 2026-08-03:** the approved Docs retention map has been applied. Historical
material is grouped under `Docs/Archive/`; unresolved facts that survived the move are summarized
without roadmap authority in `Docs/References/deferred-decisions.md`.
...
`Docs/Archive/Specs/Features/module-spec.md` is valuable historical evidence. Its still-valid
decisions requiring live revalidation are preserved in `Docs/References/deferred-decisions.md`.
